	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url();?>assets/templates/Login/images/kemensos.jpg');">
			<div class="wrap-login100 p-t-190 p-b-1">
				<form class="login100-form validate-form" action="<?php echo base_url('login/check_valid_email') ?>" method="post">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Format email salah">
						<input class="input100" type="text" name="email" placeholder="Masukan email yang terdaftar..!">
